		...
		<form action="" @submit.prevent="submit">
				<div class="addynamic">
						...
						<div class="addynamic_content">
								<div class="hweight">
										<textarea name="wtextarea" maxlength="200" id="textarea" v-model="inputText.wtextarea" placeholder="最多输入200字"></textarea>
								</div>
								<!--长按删除钮出来-->
								<div class="bothImg">
								...
								<div class="content_bottom">
										...
										<!--点击笑脸调表情-->
										<!--<span class="iconfont icon-face" id="btn" @click="btnLoad2"></span>-->
								</div>
						</div>
				</div>
		</form>
				...
				methods: {
						...
						update(event){
								...
								if(event.target.files.length>0){
										...
										this.$axios.post(url+'/portal/attachment/appupload',param,config).then(res=>{
												console.log('图片文字');
												console.log(res);
