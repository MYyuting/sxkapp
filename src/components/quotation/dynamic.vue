<template>
		<div class="dynamic">
				...
				<router-link  v-show="userType!=3"  tag="div" class="add_dynamic beijing" to="/addynamic"><img src="../../assets/img/FaXingRen/addNewsOrService@2x.png" alt="" /></router-link>
				<div class="wadd" v-show="userType==3">
