						...
						<div class="con-top">
								<div class="shu-left">
										<div>
												...
												<div class="right-img">
														<p class="name-til">{{dataMy.investorsName}}
																<i class="iconfont icon-fans" v-show="dataMy.isFans == 1"></i>
														</p>
...
<script>
    ...
    export default {
        name: "shenGXQ",
		        ...
		        //判断发行人是否为我的粉丝
// 	/api/investors/findTInvestorsIsFans 参数：token、发行人编码investorsCode
        		// 是否自选
						getStatus(){
						...
						dongTai(){
								this.$axios.post(url+'/sxz/api/findSxzRecordPageList',this.$qs.stringify({
										...
										if(res.data.status == 0){
												this.dongTaiJson = res.data.data.list
